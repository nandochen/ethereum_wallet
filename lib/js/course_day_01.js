 ...
 * 4) 產生以太坊錢包
 * 5) 使用EtherScan 
 * 6) 申請EtherScan API 金鑰 
 * 
 * Course 1/3: 1.5 Hours
 * 1) Architecture
 * 2) Key Technologies, components
 * 3) System functions
 * 4) Generate Ethereum Wallet
 * 5) How to use EtherScan 
 * 6) Apply EtherScan API key
 * 
 * Author: 陳俊欽 Nando 
 * Create: 2021/03/30 
 * Update: 2021/04/03
...
//============================================================================= 
// 錢包地址 / Wallet Address 
var myAddress = '0x9F46964918BFd7260A0dc6c84a95D959A1acbf16';
// 私鑰，正式環境請勿暴露此資訊!! / Private key, DO NOT SHOW IN LIVE ENV.!!                                                         
var myPK = '0xdc2e10e411fe4f76aebda7b9295c32f1627b69cc085310cda1538efcd096d3ec';
...
function gotoWallet(){
    ...
    swapView('#viewWallet', function(){
        ...
        $('#lbBalance').html('---');
        // To-do: 調用取得餘額功能
        // To-do: Invoke get balance function 
    });
}
...
function gotoTransaction() { 
    ...
    swapView('#viewTransfer', function(){  
        ...
        // To-dos: 調用取得餘額功能 
        // To-dos: Invoke get balance function 
    });
}
...
function gotoDetail(_hash, _index) {
    ...
    swapView('#viewDetail', function(){
        ...
        // To-dos: 取得交易明細收據
        // To-dos: Get transaction detail receipt
    });
}
